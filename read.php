			<table class="table table-striped">
				...
				?>
					<tr>
						...
						<td>
						<a href="index.php?page=edit&id=<?php echo $m['id'];?>"><button type="button" class="btn btn-dark">Edit <i class="fa fa-pencil"></i></button></a>
						<a href="index.php?page=delete&id=<?php echo $m['id'];?>"onclick="return confirm('Anda yakin mau menghapus Data ini?')"><button type="button" class="btn btn-danger">Hapus <i class="fa fa-trash-o"></i></button></a>
						</td>
					</tr>
				<?php
					}
